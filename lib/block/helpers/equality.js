      ...
      return function(_super) {
        return function(value) {
          ...
          if (property != null) {
            ...
            return this.assert(assertion(actual, expected), "expected block " + block.id + " to have a " + propertyName + " " + preposition + " \#{exp} but got \#{act}", "expected block " + block.id + " to not have a " + propertyName + " " + preposition + " \#{exp} but got \#{act}", actual, expected);
          } else {
