      ...
      return function(_super) {
        return function(expected) {
          ...
          if (target != null) {
            ...
            return this.assert(negated ? !result : result, "expected block " + block.id + " to have a " + path + " with length " + preposition + " \#{exp} but length was \#{act}", "expected block " + block.id + " to not have a " + path + " with length " + preposition + " \#{exp} but length was \#{act}", expected, actual);
          } else {
